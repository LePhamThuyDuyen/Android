...
public class Tudong extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tudong);
        ...
        tv_M1 = findViewById(R.id.tx_kqMay1);
        tv_M2 = findViewById(R.id.tx_kqMay2);
       ...
       bt_ran.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View v) {
               new CountDownTimer (10000,2000){
                   ...
                   int may1 = 0;
                   @Override
                   public void onTick(long millisUntilFinished) {//millisUntilFinished so mili con lai cua bo dem
                       Random ran = new Random();
                       dem++;

                       int b1, b2, b3, b4, b5, b6;
                       int kqMay1 = 0, kqMay2 = 0;
                       ...
                       kqMay1 += soNut(Integer.parseInt(ig1.getTag().toString()));
                       kqMay1 += soNut(Integer.parseInt(ig2.getTag().toString()));
                       kqMay1 += soNut(Integer.parseInt(ig3.getTag().toString()));
                       ...
                       if (demMay == 3)
                           ...
                           tv_M1.setText("Ban la ba tay");
                       else
                           tv_M1.setText("Nut:" + kqMay1%10);
                       ...
                       kqMay2 += soNut(Integer.parseInt(ig4.getTag().toString()));
                       kqMay2 += soNut(Integer.parseInt(ig5.getTag().toString()));
                       kqMay2 += soNut(Integer.parseInt(ig6.getTag().toString()));
                       ...
                       if (demNguoi == 3)
                           ...
                           tv_M2.setText("Ban la ba tay");
                       else
                           tv_M2.setText("Nut:" + kqMay2 % 10);

                       if (kqMay1%10 > kqMay2%10) {
                           may1++;
                       } else if (kqMay1%10 < kqMay2%10) {
                           may2++;
                       }
                   ...
                   public void onFinish() {
                       AlertDialog.Builder mydialog = new AlertDialog.Builder(Tudong.this);
                       if (may1<may2)
                           mydialog.setTitle("Máy 2 thắng");
                       else if (may1>may2)
                           mydialog.setTitle("Máy 1 thắng");
